...
<?php 
 ...
 $select = $conn->query("SELECT * FROM worker WHERE status = 1 ");
 $select->execute();
        ...
        <div class="col">
          <div class="card">
            <div class="card-body">
             ...
             <a  href="<?php echo ADMINURL?>Workers/workerRequest.php" class="btn btn-primary mb-4 text-center float-right">show worker request</a>
              <table class="table">
                <thead>
                  <tr>
                    <th scope="col">#</th>
